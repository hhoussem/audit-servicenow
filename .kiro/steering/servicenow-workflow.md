...
### Flow Triggers
- Trigger: Record created on `x_ec_audit_t_audits`
...
completeStep: function(auditSysId, stepInfo) {
    ...
    var visaGr = new GlideRecord('x_ec_audit_t_visas');
    visaGr.initialize();
    ...
    var auditGr = new GlideRecord('x_ec_audit_t_audits');
...
terminateWorkflow: function(auditSysId, reason) {
    ...
    // Close open tasks
    var taskGr = new GlideRecord('x_ec_audit_workflow_task');
