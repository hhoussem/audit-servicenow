...
IntegrationSpoke.prototype = {
    initialize: function() {
        this.endpoint = gs.getProperty('x_1936206_audit.[system].endpoint');
...
- `x_1936206_audit.cris.endpoint` - CRIS REST API base URL
- `x_1936206_audit.summa.endpoint` - SUMMA REST API base URL
- `x_1936206_audit.hrs.endpoint` - HRS REST API base URL
