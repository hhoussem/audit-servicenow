...
This project is a ServiceNow scoped application (`x_1936206_audit`) for the OPSYS Audit Management System, migrated from Java/Oracle/WebLogic.

## Application Context

- Application Scope: `x_1936206_audit`
...
- Oracle `T_AUDITS` → ServiceNow `x_1936206_audit_t_audits`
- Oracle `T_AUDIT_RESULTS` → ServiceNow `x_1936206_audit_t_audit_results`
- Oracle `T_CREF_*` → ServiceNow `x_1936206_audit_t_cref_*`
