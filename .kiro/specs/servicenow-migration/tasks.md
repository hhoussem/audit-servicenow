...
- [-] 1. Create Application Scope and Core Tables
  - [x] 1.1 Create scoped application `x_1936206_audit` with appropriate settings
    - Configure application scope prefix
    - Set up application properties
    - _Requirements: 1.1, 1.2_

  - [ ] 1.2 Create core audit table `T_AUDITS` (x_1936206_audit_t_audits) with all fields
