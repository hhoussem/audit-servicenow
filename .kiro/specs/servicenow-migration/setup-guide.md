...
- All tables will be prefixed with `x_1936206_audit_`
...
|-------|-------|
| Label | Audit |
| Name | x_1936206_audit_audit (auto-generated) |
...
```javascript
var gr = new GlideRecord('x_1936206_audit_audit');
if (gr.get(sysId)) {
...
1. Create the `x_1936206_audit` scoped application
