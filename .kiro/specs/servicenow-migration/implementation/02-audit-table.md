...
5. **Fill Table Details:**
   ...
   |-------|-------|
   | Label | T_AUDITS |
   | Name | t_audits (will become x_ec_audit_t_audits) |
   | Extends table | None |
...
|--------------|-------------|------|-----------------|-------|
| CAUT_NSQ | caut_nsq | Reference | x_ec_audit_t_cref_audit_types | Audit type (mandatory) |
| CAUS_NSQ | caus_nsq | Reference | x_ec_audit_t_cref_audit_status | Audit status (mandatory) |
| CARE_NSQ | care_nsq | Reference | x_ec_audit_t_cref_audit_reasons | Audit reason |
| CRAD_NSQ | crad_nsq | Reference | x_ec_audit_t_cref_reason_additions | Reason not in initial plan |
| CACR_NSQ | cacr_nsq | Reference | x_ec_audit_t_cref_audit_cancel_reasons | Cancellation reason |
| CDIR_NSQ | cdir_nsq | Reference | x_ec_audit_t_cref_directorates | Directorate in charge |
| CUNI_NSQ | cuni_nsq | Reference | x_ec_audit_t_cref_units | Unit in charge |
| CDEL_NSQ | cdel_nsq | Reference | x_ec_audit_t_cref_delegations | Delegation in charge |
...
2. **Create Number Record**
   ...
   | Field | Value |
   |-------|-------|
   | Table | T_AUDITS [x_ec_audit_t_audits] |
...
1. **Open the table definition**
   - In Studio, click on x_ec_audit_t_audits table
...
1. **Open the table form**
   - Type "x_ec_audit_t_audits.list" in navigator
