...
var refTables = [
    'x_ec_audit_t_cref_audit_types',
    'x_ec_audit_t_cref_audit_status',
    'x_ec_audit_t_cref_audit_reasons',
    'x_ec_audit_t_cref_audit_cancel_reasons',
    'x_ec_audit_t_cref_reason_additions',
    'x_ec_audit_t_cref_audit_roles',
    'x_ec_audit_t_cref_audit_visa_steps',
    'x_ec_audit_t_cref_audit_visa_decisions',
    'x_ec_audit_t_cref_audit_timings',
    'x_ec_audit_t_cref_currencies',
    'x_ec_audit_t_cref_exchange_rate_sources',
    'x_ec_audit_t_cref_opinion_fin_audits',
    'x_ec_audit_t_cref_opinion_sys_audits',
    'x_ec_audit_t_cref_opinion_system_types',
    'x_ec_audit_t_cref_audit_documents',
    'x_ec_audit_t_cref_audit_check_groups',
    'x_ec_audit_t_cref_audit_finding_groups',
    'x_ec_audit_t_cref_categories',
    'x_ec_audit_t_cref_directorates',
    'x_ec_audit_t_cref_units',
    'x_ec_audit_t_cref_delegations'
];
