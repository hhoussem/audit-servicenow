...
The application will be developed as a scoped application with the prefix `x_1936206_audit` to ensure proper namespace isolation and maintainability.
...
|--------------|------------------|
| T_AUDITS | x_1936206_audit_t_audits |
| T_AUDIT_RESULTS | x_1936206_audit_t_audit_results |
| T_AUDIT_RESULT_AMOUNTS | x_1936206_audit_t_audit_result_amounts |
| T_AUDIT_RESULT_FINDINGS | x_1936206_audit_t_audit_result_findings |
| T_AUDIT_RESULT_PILLARS | x_1936206_audit_t_audit_result_pillars |
| T_AUDIT_CHECKLISTS | x_1936206_audit_t_audit_checklists |
| T_AUDIT_CHECKLIST_MASTERS | x_1936206_audit_t_audit_checklist_masters |
| T_AUDIT_CHECKLIST_DETAILS | x_1936206_audit_t_audit_checklist_details |
| T_PERSON_IN_CHARGES | x_1936206_audit_t_person_in_charges |
| T_VISAS | x_1936206_audit_t_visas |
| T_DOCUMENTS | x_1936206_audit_t_documents |
| T_AUDIT_NON_FINANCIAL_ACTIONS | x_1936206_audit_t_audit_non_financial_actions |
| T_AUDIT_RECOVERY_ACTIONS | x_1936206_audit_t_audit_recovery_actions |
| T_AUDIT_VALIDATION_MSGS | x_1936206_audit_t_audit_validation_msgs |
| T_AUDITED_CONTRACT_LINKS | x_1936206_audit_t_audited_contract_links |
| T_CREF_* (reference tables) | x_1936206_audit_t_cref_* |
...
#### x_1936206_audit_audit (Main Audit Table)
...
#### x_1936206_audit_result (Audit Results)
| Field | Type | Description |
|-------|------|-------------|
...
#### x_1936206_audit_result_amount (Financial Results)
| Field | Type | Description |
|-------|------|-------------|
...
#### x_1936206_audit_finding (Audit Findings)
| Field | Type | Description |
|-------|------|-------------|
| audit_result | Reference | Parent result |
...
#### x_1936206_audit_pillar_result (Pillar Assessments)
| Field | Type | Description |
|-------|------|-------------|
| audit_result | Reference | Parent result |
...
#### x_1936206_audit_checklist (Checklist Responses)
| Field | Type | Description |
|-------|------|-------------|
| audit | Reference | Parent audit |
...
#### x_1936206_audit_person_in_charge (Role Assignments)
| Field | Type | Description |
|-------|------|-------------|
| audit | Reference | Parent audit |
...
#### x_1936206_audit_action_plan (Non-Financial Actions)
| Field | Type | Description |
|-------|------|-------------|
| audit | Reference | Parent audit |
...
#### x_1936206_audit_recovery_action (Financial Recovery)
| Field | Type | Description |
|-------|------|-------------|
| audit | Reference | Parent audit |
...
#### x_1936206_audit_document (Document References)
| Field | Type | Description |
|-------|------|-------------|
| audit | Reference | Parent audit |
...
#### x_1936206_audit_visa (Approval Records)
| Field | Type | Description |
|-------|------|-------------|
| audit | Reference | Parent audit |
...
#### x_1936206_audit_validation_message (Validation Messages)
| Field | Type | Description |
|-------|------|-------------|
| audit | Reference | Parent audit |
...
#### x_1936206_audit_checklist_template (Checklist Templates)
| Field | Type | Description |
|-------|------|-------------|
...
#### x_1936206_audit_checklist_template_detail (Checklist Items)
| Field | Type | Description |
|-------|------|-------------|
...
#### x_1936206_audit_finding_template (Finding Templates)
| Field | Type | Description |
|-------|------|-------------|
...
#### x_1936206_audit_finding_template_detail (Finding Items)
| Field | Type | Description |
|-------|------|-------------|
| template | Reference | Parent template |
...
#### x_1936206_audit_pillar_template (Pillar Templates)
| Field | Type | Description |
|-------|------|-------------|
| start_date | Date | Validity start date |
| active | Boolean | Currently active |

#### x_1936206_audit_pillar_template_detail (Pillar Items)
| Field | Type | Description |
|-------|------|-------------|
| template | Reference | Parent template |
...
#### x_1936206_audit_ref_audit_type
#### x_1936206_audit_ref_audit_status
#### x_1936206_audit_ref_audit_reason
#### x_1936206_audit_ref_audit_timing
#### x_1936206_audit_ref_audit_role
#### x_1936206_audit_ref_cancel_reason
#### x_1936206_audit_ref_finding_group
#### x_1936206_audit_ref_check_group
#### x_1936206_audit_ref_document_type
#### x_1936206_audit_ref_visa_step
#### x_1936206_audit_ref_currency
#### x_1936206_audit_ref_exchange_rate_source
#### x_1936206_audit_ref_delegation
#### x_1936206_audit_ref_directorate
#### x_1936206_audit_ref_unit
...
CRISIntegrationSpoke.prototype = {
    initialize: function() {
        this.endpoint = gs.getProperty('x_1936206_audit.cris.endpoint');
    },
...
SUMMAIntegrationSpoke.prototype = {
    initialize: function() {
        this.endpoint = gs.getProperty('x_1936206_audit.summa.endpoint');
    },
...
HRSIntegrationSpoke.prototype = {
    initialize: function() {
        this.endpoint = gs.getProperty('x_1936206_audit.hrs.endpoint');
    },
